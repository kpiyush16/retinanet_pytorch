...
class CSVDataset(Dataset):
    ...
    def __init__(self, train_file, class_list, transform=None):
        ...
        # parse the csv with img_path, x1, y1, x2, y2, class_name
        try:
        ...
        # print("Total Number of Images:", len(self.image_names))
    ...
    def load_image(self, image_index):
        ...
        leng = len(img.shape)
        if(leng<2):
            img_name = self.image_names[image_index].split(".")[0]
            print("Repairing some JPEGs")
            st = ["mogrify -format png {}.jpg".format(img_name), "rm {}.jpg".format(img_name),
                "mogrify -format jpg {}.png".format(img_name), "rm {}.png".format(img_name)]
            for s in st:
            ...
            img = skimage.io.imread(self.image_names[image_index])
        #     print(self.image_names[image_index], img.shape)
        if leng == 2:
